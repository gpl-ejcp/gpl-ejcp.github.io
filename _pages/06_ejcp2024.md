...
Dans ce cours, vous apprendrez les bases des langages synchrones et les détails d’une approche industrielle pour leur application dans un logiciel temps réel. Dans la partie pratique, vous utiliserez OCaml et un programme linéaire en nombres entiers pour transformer un programme source en un code séquentiel.
